...
<body>
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" style="background-color: #E0EEE0;text-align: right;">
  <tr>
    <td><a href="jsp/register.jsp" style="text-decoration:none;color:#3399CC;">注册&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
  </tr>
</table>
        ...
        <td height="95"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="183" background="images/login_07.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="21%" height="30"><div align="center"><span class="STYLE3">电话</span></div></td>
              ...
              <tr>
                ...
                <input type="submit" value="提交" style="width:40px;height:22px;"/>
                <input type="reset" onclick="" value="重置" style="width:40px ;height:22px;"/>
                </td>
              </tr>
            </table></td>
